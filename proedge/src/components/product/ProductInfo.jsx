...
const ProductInfo = () => {
  return (
    <div className="w-full lg:max-w-[564px] h-auto lg:h-[554px] flex flex-col justify-between items-start gap-6 lg:gap-0 p-1 lg:p-0">
      <div className="text-lg leading-7 text-[#3F66BC] font-medium h-auto lg:h-[232px] flex flex-col justify-between gap-4 lg:gap-0">
        ...
        <div className="text-[14px] lg:text-[16px] leading-6 flex flex-wrap w-[265px] justify-evenly lg:justify-between items-center ">
        ...
        <div className="bg-[#3F66BC] w-full lg:w-[184px] h-[32px] relative overflow-hidden flex items-center justify-center text-white text-sm font-medium">
          <div className="bg-white w-[64px] h-[64px] absolute right-0 transform translate-y-4 translate-x-11 rotate-45"></div>
          <div className="absolute left-18 md:left-3 z-10 font-bold text-sm leading-5">
      ...
      <div className="flex flex-col h-auto lg:h-[128px] justify-between gap-4 lg:gap-0">
        <div className="flex items-center justify-start lg:justify-between w-full lg:w-[77px] text-[16px] leading-4 text-[#182B55]">
          <span>$</span>&nbsp;
          <h1 className="text-3xl lg:text-[40px] font-medium leading-12">
            230
          </h1>
          &nbsp;<span>45</span>
        </div>
        <div>
          <div>
            <p className="text-lg lg:text-xl leading-8">
              <span className="font-medium text-[#3F66BC]">
                Typical price:{" "}
              </span>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center">
              ...
              <div className="flex items-center">
                <span className="text-[#3F66BC] font-medium text-[14px] lg:text-[16px]">
                  Details
                </span>
                <svg
                  width="20"
