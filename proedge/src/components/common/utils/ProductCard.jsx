        ...
        <div className="max-w-lg border-2 border-[#F8F9FB] px-4 pt-4 pb-6 bg-[#FFFFFF]">
            <div className="rounded-xl w-full h-[417px] mb-5 bg-[#FFFFFF]">
                    ...
                    <div
                        ...
                        >
                            <path
                                ...
                                className="fill-[#182B55] group-hover:fill-white transition duration-300"
                            />
                        </svg>
                    </div>
                ...
                <div className="flex flex-col justify-between items-start h-[247px] w-full">
                    <div className="mb-2">
                        <h2 className="text-[14px] text-[#3F66BC] font-medium leading-10"> {category} </h2>
                        <h1 className="text-[#475467] text-lg font-medium leading-[30px]">{title}</h1>
                    </div>
                    <div className="mb-[10px]">
                        <p className="text-[#3F66BC] text-2xl font-semibold leading-8 gap-2.5">${price}</p>
                    </div>
                    <div
                        className="bg-[#FCD700] rounded-[60px] text-center w-full h-[40px] py-2 px-6 flex items-center justify-center hover:bg-[#e6c200] cursor-pointer transition duration-300">
                        <h3 className="text-[16px] text-[#182B55] font-medium leading-6">Add to Cart</h3>
                    </div>
