  ...
  return (
    <>
              ...
              <button className="w-full px-5 py-4 bg-[#182B55] text-white rounded-full flex justify-between items-center gap-2">
                ...
                {/* <!-- Text --> */}
                <span className="text-md md:text-lg lg:text-xl font-semibold">Browse Products</span>

                {/* <!-- Down Arrow --> */}
                <svg width="18" height="9" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              {/* <!-- Dropdown --> */}
              <div
                className="absolute top-full -translate-x-5 mt-2 md:mt-7 w-full md:w-[800px] mt-2 z-50 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300">
                  ...
                  <div className="flex flex-col lg:flex-row min-h-[400px]">
                          ...
                          <div className="block group/item p-4 hover:bg-[#3F66BC] cursor-pointer transition-colors min-h-[64px]">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <img src="./src/assets/category/category1.png" alt="Air Treatment Systems"
                    ...
                    <div className="lg:w-4/7 p-6">
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold w-[365px] text-[#182B55]">Electric Motors & Motor Controls</h2>
                        <a href="#" className="text-[#3F66BC] text-md w-[100px] hover:text-[#2E4A8E] transition-colors">Shop All
                        </a>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                          <h3 className="font-semibold text-gray-800 mb-2">Contactors</h3>
                          <ul className="space-y-2 text-sm">
                            <li><a href="#" className="flex justify-between items-center text-gray-600 hover:text-[#3F66BC]">
                              <span>Shop All</span><span className="text-[#3F66BC] text-sm">(3)</span></a></li>
                            <li><a href="#" className="flex justify-between items-center text-gray-600 hover:text-[#3F66BC]">
                              <span>2-Pole</span><span className="text-[#3F66BC] text-sm">(3)</span></a></li>
                            <li><a href="#" className="flex justify-between items-center text-gray-600 hover:text-[#3F66BC]">
                              <span>3-Pole</span><span className="text-[#3F66BC] text-sm">(18)</span></a></li>
                          </ul>
                        </div>
