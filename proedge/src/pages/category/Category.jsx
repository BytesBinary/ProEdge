...
const Category = () => {
  ...
  const [showFilter, setShowFilter] = useState(false); // State to toggle filter visibility in mobile view
      ...
      <div className="w-full max-w-[1200px] mx-auto mt-3 md:mt-20 flex flex-col lg:flex-row justify-between items-start gap-10">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="hidden lg:flex items-center justify-between mb-6">
            {/* Showing Items */}
            <h1 className="text-[#182B55] font-medium text-lg">Showing 23 items</h1>
            ...
            <div className="bg-[#F8F9FB] border-2 border-[#ECF0F9] rounded-[42px] w-24 h-10 py-3 px-5 flex items-center justify-around">
              ...
              <h2 className="text-[#182B55] font-medium text-xl leading-6">10</h2>
            </div>
          ...
          <div className="w-full flex flex-col gap-4 lg:hidden">
            ...
            <div className="w-full flex items-center justify-around">
              {/* Showing Items */}
              <h1 className="text-[#182B55] font-medium text-md">Showing 23 items</h1>
              ...
              <div className="bg-[#F8F9FB] border-2 border-[#ECF0F9] rounded-[42px] w-20 h-9 py-2 px-4 flex items-center justify-around">
                ...
                <h2 className="text-[#182B55] font-medium text-md leading-6">10</h2>
              </div>
            </div>
          </div>
