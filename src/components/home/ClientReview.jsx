...
const ReviewCard = ({ name, role, image, title, review, stars = "⭐⭐⭐⭐⭐" }) => (
  <div className="w-full h-[266px] rounded-[20px] border-2 border-[#F8F9FB] hover:border-[#182B55] hover:bg-gray-100 shadow-sm hover:shadow-md flex flex-col justify-between items-start gap-4 py-6 px-4 mb-6 md:mb-0">
    <div>
      <span>{stars}</span>
